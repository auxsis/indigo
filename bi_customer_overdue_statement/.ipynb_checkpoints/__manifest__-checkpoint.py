...

{
    ...
    'description': """
        ...
        Print Customer Statement, Print Supplier Statement .Send Customer Statement by email. Send supplier statement by email .Account Statement,Partner statement, Balance Sheet, ledger Report, Print Account Statement, Accounting Reports, Statement Reports, Customer report, Balance Statement,Customer Balance Report, Customer ledger report, ledger balance.Credit Statement, Debit Statement.Customer Overdue statement.Accounting Statement, Creditor Reports, Debtor Reports.Account follo-wup, Account followup report, payment followup report, payment follow-up.
        Print Ledger report according to customer and supplier.
...
""",
    ...
    'images': [],
    'depends': ['base', 'account_invoicing', 'sale_management', 'mail', 'sales_team'],
