        ...
        if(self._context.get('analytic')):
            ...
            query = '''
                ...
                WHERE (l.account_id = account_account.id)
                    ...
                    AND ((l.analytic_account_id is not NULL))
            ...
            return super(report_account_aged_partner, self)._get_partner_move_lines(account_type, date_from, target_move, period_length)
