# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'sale', 'r2d2', 'product', 'stock', 'stock_picking_batch', 'delivery', 'hr_disciplinary_tracking', 'bi_account_cheque', 'hr_expense', 'account_reports', 'account_reports_followup', 'purchase', 'ibas_indigo'],
